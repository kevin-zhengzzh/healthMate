<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="sleepTime" label="SleepTime"></el-table-column>
        <el-table-column prop="wakeupTime" label="WakeupTime"></el-table-column>
        <el-table-column prop="sleepDuration" label="SleepDuration">
          <template v-slot="scope">{{ scope.row.sleepDuration }} h</template>
        </el-table-column>
        <el-table-column prop="sleepQuality" label="SleepQuality"></el-table-column>
  ...
  <el-dialog title="Sleep records information" v-model="data.formVisible" width="40%" destroy-on-close>
    <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="170px" style="padding:20px">
      <el-form-item prop="sleepTime" label="SleepTime">
        <el-time-select style="width: 300px" start="00:00" end="23:30" v-model="data.form.sleepTime" placeholder="Please insert sleep time"></el-time-select>
      </el-form-item>
      <el-form-item prop="wakeupTime" label="WakeupTime">
        <el-time-select style="width: 300px" start="00:00" end="23:30" v-model="data.form.wakeupTime" placeholder="Please insert wakeup time"></el-time-select>
      </el-form-item>
      <el-form-item prop="sleepQuality" label="SleepQuality">
        <el-select style="width: 300px" v-model="data.form.sleepQuality" placeholder="Please insert sleepQuality">
          <el-option v-for="item in ['Great','Good','Average','Bad']" :key="item" :value="item" :label="item"></el-option>
        </el-select>
      </el-form-item>
...
const data = reactive({
  ...
  rules: {
    sleepTime: [
      { required: true, message: 'Please insert sleep time', trigger: 'change' }
    ],
    wakeupTime: [
      { required: true, message: 'Please insert wakeup time', trigger: 'change' }
    ],
    sleepQuality: [
      { required: true, message: 'Please select sleepQuality', trigger: 'change' }
    ],
  }
})
