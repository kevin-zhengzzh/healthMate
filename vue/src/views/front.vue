<template>
  <div>
    <div class="front-notice"><el-icon><Bell /></el-icon>Announcement: {{data.top}}</div>
    <div class="front-header">
      ...
      <div class="front-header-center">
        <el-menu :default-active="router.currentRoute.value.path" router mode="horizontal">
          ...
          <el-menu-item index="/front/person">user center</el-menu-item>
        </el-menu>
      </div>
      <div class="front-header-right">
        <div v-if="!data.user.id">
          <el-button @click="router.push('/Login')">login</el-button>
          <el-button @click="router.push('/Register')">registration</el-button>
        </div>
        <div v-else>
